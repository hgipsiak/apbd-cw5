...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.Where(e => depts.Where(l => l.Loc.Equals("CHICAGO"))
            .Select(l => l.DeptNo).ToList().Contains(e.DeptNo)).ToList(); 
    ...
    public void ShouldSelectNamesAndSalaries()
    {
        ...
        var result = emps.Select(e => new {EName = e.EName, Sal = e.Sal}).ToList(); 
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result = emps.Join(depts, e => e.DeptNo, d => d.DeptNo, (e, d) => new
        {
            EName = e.EName,
            DName = d.DName
        }).ToList(); 
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps.Where(e => e.Comm != null).SelectMany(e => new[] {e}).ToList(); 
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e => e.Sal > emps.Where(e1 => e1.DeptNo == e.DeptNo).Average(e1 => e1.Sal))
